...
export GOBIN=/n64chain/tools/bin

mkdir /go
cd /go
git clone https://github.com/kamshi/spicy.git
cd spicy
git checkout new-ld-arguments
go mod tidy
go install ./cmd/spicy
...
#go install github.com/kamshi/spicy/cmd/spicy@refs/heads/new-ld-arguments
